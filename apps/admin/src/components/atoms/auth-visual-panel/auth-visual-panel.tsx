		...
		<aside className="sticky top-0 hidden h-screen flex-col justify-between bg-surface-navy px-13 py-15 xl:flex xl:w-150 dark:bg-surface-navy-2">
			<div className="flex flex-col gap-3.5">
				...
				<h2 className="font-instrument-serif text-[48px] text-foreground-inverse leading-[1.1] tracking-[-1.2px]">
					A orquestra de serviços que não para de tocar!
				</h2>
			...
			<div className="flex flex-col gap-4 rounded-[14px] border border-border-on-navy bg-surface-navy-2 p-5.5">
				...
				<div className="flex items-center gap-3.5">
					<div className="flex h-10.5 w-10.5 shrink-0 items-center justify-center rounded-full bg-surface">
