...
export function CompanyStatsRow() {
	return (
		<section className="grid grid-cols-1 gap-3.5 sm:grid-cols-2 lg:grid-cols-4">
			...
			/>
			<StatCard
				caption={<span className="text-success">+18% vs último trimestre</span>}
				eyebrow="Faturamento · 2025"
				value={formatCurrency.format(168_420)}
			/>
			<StatCard
				caption="218 avaliações neste ano"
				eyebrow="Avaliação média"
				value={
